...
def main(argv):
  ...
  run_tabular_dual_dice(
    ...
    gamma, solve_for_state_action_ratio,
    load_dir, load_dir, save_dir)

def run_tabular_dual_dice(
    env_name, tabular_obs, alpha, seed, num_trajectory, max_trajectory_length,
    gamma, solve_for_state_action_ratio,
  ...
  estimator = TabularDualDice(dataset_spec=dataset.spec, gamma=gamma, solve_for_state_action_ratio=solve_for_state_action_ratio)
