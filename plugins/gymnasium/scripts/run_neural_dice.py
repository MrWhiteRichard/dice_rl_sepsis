...
def main(argv):
  ...
  run_neural_dice(
    ...
    nu_learning_rate, zeta_learning_rate, zero_reward, primal_regularizer, dual_regularizer, nu_regularizer, zeta_regularizer, norm_regularizer, primal_form, f_exponent, zeta_pos, scale_reward, shift_reward, transform_reward,
...
def run_neural_dice(
    ...
    num_steps, batch_size,
    gamma, reward_fn,
    load_dir_dataset, load_dir_policy, save_dir):
  ...
  directory = os.path.join(load_dir_dataset, hparam_str)
